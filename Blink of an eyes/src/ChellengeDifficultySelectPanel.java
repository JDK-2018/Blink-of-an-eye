...
public class ChellengeDifficultySelectPanel extends JPanel {
	...
	public ChellengeDifficultySelectPanel(){
        ...
        title = new JLabel("√ß∏∞¡ˆ ∏µÂ");
        title.setForeground(Color.WHITE);
        title.setFont(new Font("«—√ ∑“πŸ≈¡",Font.BOLD,70));
        ...
        easyButton.setFont(new Font("«—√ ∑“πŸ≈¡",Font.PLAIN,50));
        ...
        normalButton.setFont(new Font("«—√ ∑“πŸ≈¡",Font.PLAIN,50));
        ...
        hardButton.setFont(new Font("«—√ ∑“πŸ≈¡",Font.PLAIN,50));
        this.add(title);
        this.add(easyButton);
